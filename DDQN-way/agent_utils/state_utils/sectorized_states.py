...
def computeSectorized(listOfBerries:np.ndarray, info:dict, 
                        berry_worth_function:'function', halfDiagonalLen:float,
...
if __name__ == "__main__":
    ...
    state, avgWorth, worths = computeSectorized(berries, None, berryWorthFunc, 0.5*(1920**2 + 1080**2)**0.5)