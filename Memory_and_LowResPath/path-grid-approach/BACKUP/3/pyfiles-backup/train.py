...
if __name__ == '__main__':
    ...
    ddqn_trainer = DDQN(berry_env, nnet, tstrat, optim, buffer, batchSize=512, skipSteps=10,
                        ...
                        gamma=0.8, MaxTrainEpisodes=800, optimize_every_kth_action=1000,
                        user_printFn=print_fn, printFreq=1, polyak_tau=0.2, polyak_average= True, num_gradient_steps= 100,
