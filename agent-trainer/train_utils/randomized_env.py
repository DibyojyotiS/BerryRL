...
def getRandomEnv(field_size=(20000,20000), patch_size=(2600,2600), num_patches=10, 
                seperation=2400, nberries=80, initial_juice=0.5, 
                ...
                spawn_radius=100, sampling_type=0, 
                show=False) -> BerryFieldEnv:
    """
    Every call to env.reset() creates a new random environment layout
    ### Parameters
    ...
    berry_env = BerryFieldEnv(
        ...
        berry_data=random_berry_data,
        end_on_boundary_hit=end_on_boundary_hit,
        play_till_maxtime=play_till_maxtime
    )
