...
if __name__ == "__main__":
    ...
    bounding_boxes = env.field.berry_collision_tree.boxes
    berry_collision_tree = env.field.berry_collision_tree
    ...
    for i, berryId in enumerate(found_Ids):
        ...
        f(env.field.berry_collision_tree.intervaltreeX.root, 'x')
        f(env.field.berry_collision_tree.intervaltreeY.root, 'y')
        temp = []
